...
function ProfileCard() {
  const { githubUser, errorProfileCard } = useGitHubUser();
  if (!githubUser) {
    return (
      <>
  ...
  return (
    <>
      <section className={styles.cardContainer}>
        <div className={styles.userImgText}>
          <img
          ...
          <div className={styles.userInfoText}>
            <p className={styles.username}>
              {githubUser.name} <span>@{githubUser.login}</span>
            </p>
            <p className={styles.joinDate}>
              Joined {FormatJoindate(githubUser.created_at)}
            </p>
          </div>
        </div>
        ...
        <div className={styles.userInfo}>
          {githubUser.bio ? (
            <p className={styles.userBio}>{githubUser.bio}</p>
          ) : (
            <p className={styles.userBio}>This profile has no bio</p>
          )}
          <div className={styles.followContainer}>
            <p className={styles.repoTitle}>
              Repos <span>{githubUser.public_repos}</span>
            </p>
            <p className={styles.repoTitle}>
              Followers <span>{githubUser.followers}</span>
            </p>
            <p className={styles.repoTitle}>
              Following <span>{githubUser.following}</span>
            </p>
          </div>
          <div className={styles.linkContainer}>
            <div className={styles.link}>
              ...
              <p className={styles.linkText}>{githubUser.location}</p>
            </div>
            <div className={styles.link}>
              ...
              {githubUser.twitter_username ? (
                <p className={styles.linkText}>{githubUser.twitter_username}</p>
              ) : (
                <p className={styles.linkText}>Not Available</p>
              )}
            </div>
            <div className={styles.link}>
              ...
              {githubUser.blog ? (
                <p className={styles.linkText}>{githubUser.blog}</p>
              ) : (
                <p className={styles.linkText}>Not Available</p>
              )}
            </div>
            <div className={styles.link}>
              ...
              {githubUser.company ? (
                <p className={styles.linkText}>{githubUser.company}</p>
              ) : (
                <p className={styles.linkText}>Not Available</p>
              )}
            </div>
        ...
        {errorProfileCard && (
          <>
            <div className={styles.profileError}>{errorProfileCard}</div>
          </>
        )}
      </section>
    </>
