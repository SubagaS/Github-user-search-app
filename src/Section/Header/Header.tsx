  ...
  return (
    <>
      <section className={styles.headerContainer}>
        {mode ? (
          <>
            <p className={styles.headerTitleDark}>devfinder</p>
            <button onClick={toggle} className={styles.darkBtn}>
              <p>Dark</p>
              <svg
                width="20"
                height="20"
          ...
          <>
            <p className={styles.headerTitleBright}>devfinder</p>
            <button onClick={toggle} className={styles.brightBtn}>
              <p>Light</p>
              <svg
                width="20"
                height="20"
